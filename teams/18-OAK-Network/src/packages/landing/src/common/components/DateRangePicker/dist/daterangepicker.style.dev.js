...
var DateRangePickerStyle = _styledComponents["default"].div(_templateObject()); // prop types can also be added from the style functions


DateRangePickerStyle.propTypes = {};
DateRangePickerStyle.displayName = 'DateRangePickerStyle';
DateRangePickerStyle.defaultProps = {// as: 'div'
};
var _default = DateRangePickerStyle;
