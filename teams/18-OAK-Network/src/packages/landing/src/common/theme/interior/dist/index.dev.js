...
var interiorTheme = {
  ...
  buttonStyles: {
    textButton: {
      border: 0,
      color: _colors["default"].label,
      padding: 0,
      height: 'auto',
      backgroundColor: "".concat(_colors["default"].transparent)
    },
    outlined: {
      borderWidth: '1px',
      borderStyle: 'solid',
...
exports.interiorTheme = interiorTheme;