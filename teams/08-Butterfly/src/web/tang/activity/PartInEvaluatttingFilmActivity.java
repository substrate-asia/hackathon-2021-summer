...
//    EditText filmEffectEV;
        ...
        partInSubmitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!subjectivityScoreET.getText().toString().equals("")&&!boxOfficeNumET.getText().toString().equals("")
                    ...
                    partInFilmEvaluateData.setFilmId(filmData.getFilmId());
                    ...
                    partInFilmEvaluateData.setEvaScore(Integer.parseInt(subjectivityScoreET.getText().toString()));
                    partInFilmEvaluateData.setForcastBoxOffice(Integer.parseInt(boxOfficeNumET.getText().toString()));
    ...
    public void upDatefilmItem(FilmDataPatInForUIEntity filmDataPatInForUIEntity ,PartInFilmEvaluateData partInFilmEvaluateData){

        EvaluattingRecycleViewAdapter.recycleViewInstance.UpdateFilmDataItem(filmDataPatInForUIEntity,partInFilmEvaluateData);
