...
public class CommentExpandAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(final int groupPosition, boolean isExpand, View convertView, ViewGroup viewGroup) {
        ...
        if(convertView == null){
            convertView = LayoutInflater.from(context).inflate(R.layout.chain_comment_item_layout, viewGroup, false);
        ...
        //头像动态加载，后面补充
//        Glide.with(context).load(R.drawable.cat)
...
//                .into(groupHolder.logo);
    ...
    public View getChildView(final int groupPosition, int childPosition, boolean b, View convertView, ViewGroup viewGroup) {
        ...
        if(convertView == null){
            convertView = LayoutInflater.from(context).inflate(R.layout.chain_comment_reply_item_layout,viewGroup, false);
