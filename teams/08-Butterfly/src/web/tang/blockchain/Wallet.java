...
import static com.tang.blockchain.ContractMethod.web3j;
...
//
//                        //测试
//                    String balance = ContractMethod.getInstance().getETHBalance(credentials).toString();
//                    Log.e(TAG,"my weallet Eth02:"+balance);
//
//
//                        //转账有问题，没有实现，总是转不了。先放一下，后面再继续解决这个问题。
//                        //测试
//                        //转发以太币
