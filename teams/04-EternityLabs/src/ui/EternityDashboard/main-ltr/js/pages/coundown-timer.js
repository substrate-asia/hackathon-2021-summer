...
$(function () {
    "use strict";
		...
		setInterval(function () {
			...
			countdown.innerHTML = '<div class="days timer col mb-30"> <div class="b-1 border-dark p-30 rounded">' + days +  ' <div class="text">Days</div></div></div> <div class="hours timer col mb-30"> <div class="b-1 border-dark p-30 rounded">' + hours + ' <div class="text">Hours</div></div></div> <div class="minutes timer col mb-30"> <div class="b-1 border-dark p-30 rounded">' + minutes + ' <div class="text">Minutes</div></div></div> <div class="seconds timer col mb-30"> <div class="b-1 border-dark p-30 rounded">' + seconds + ' <div class="text">Seconds</div></div></div>';  
