...
pub use frame_support::{
	construct_runtime, parameter_types, debug, RuntimeDebug,StorageValue,
	traits::{KeyOwnerProofSystem, Randomness,InstanceFilter,Currency},
	weights::{
		Weight, IdentityFee,
...
parameter_types! {
	...
	pub const NameLimit: u32 = 8;
}


parameter_types! {
	pub const AssetDepositBase: u128 = 100 * 10_0000_0000;
	pub const AssetDepositPerZombie: u128 = 1 * 10_0000_0000;
	pub const StringLimit: u32 = 20;
	pub const MetadataDepositBase: u128 = 10 * 10_0000_0000;
	pub const MetadataDepositPerByte: u128 = 1 * 10_0000_0000;
}
...
impl paper_file::Config for Runtime {
	type Event = Event;
	type Currency = Balances;
}
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		PaperFile: paper_file::{Pallet, Call, Event<T>},
...
impl_runtime_apis! {
	...
	impl frame_benchmarking::Benchmark<Block> for Runtime {
		fn dispatch_benchmark(
			...
			add_benchmark!(params, batches, paper_file, PaperFile);
