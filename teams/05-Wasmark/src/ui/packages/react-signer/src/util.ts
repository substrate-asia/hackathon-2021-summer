...
import type { QueueTx, QueueTxMessageSetStatus, QueueTxStatus, TxCallback, TxFailedCallback } from '@polkadot/react-components/Status/types';
...
export function handleTxResultsNoQueen (handler: 'send' | 'signAndSend', { txFailedCb = NOOP, txSuccessCb = NOOP, txUpdateCb = NOOP }: {
